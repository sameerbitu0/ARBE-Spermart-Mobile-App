...
class HomeModel extends Equatable {
  ...
  @override
  String toString() {
    return 'HomeModel(productCategories: $productCategories, campaign: $campaign, campaignProducts: $campaignProducts, sliders: $sliders, banners: $banners, flashDealProducts: $flashDealProducts, newProducts: $newProducts, topProducts: $topProducts, brands: $brands, firstCategory: $firstCategory, secondCategory: $secondCategory, thirdCategory: $thirdCategory, fourthCategory: $fourthCategory, setting: $setting)';
  }
