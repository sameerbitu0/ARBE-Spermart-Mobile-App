            ...
            BlocBuilder<SignUpBloc, SignUpModelState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration:
                      InputDecoration(hintText: 'sign_up_screen_input_name'.tr),
                );
              },
            ),
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                      hintText: 'sign_up_screen_input_email'.tr),
                );
              },
            ),
            const SizedBox(height: 16),
            BlocBuilder<SignUpBloc, SignUpModelState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'sign_up_screen_input_password_1'.tr,
            ...
            BlocBuilder<SignUpBloc, SignUpModelState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  obscureText: !_passwordVisible,
                  decoration: InputDecoration(
                    hintText: 'sign_up_screen_input_password_2'.tr,
                    suffixIcon: IconButton(
                      icon: Icon(
                        _passwordVisible
                            ? Icons.visibility
            ...
            BlocBuilder<SignUpBloc, SignUpModelState>(
              ...
              builder: (context, state) {
                ...
                return PrimaryButton(
                  text: 'sign_up_screen_sign_up_button'.tr,
                  onPressed: () {
    ...
    return BlocBuilder<SignUpBloc, SignUpModelState>(
      ...
      builder: (context, state) {
        return CheckboxListTile(
          ...
          title: Text(
            'sign_up_screen_checkbox_text'.tr,
