      ...
      builder: (context, AsyncSnapshot<int> snapshot) {
        ...
        return BlocListener<LoginBloc, LoginModelState>(
          ...
          listener: (context, state) {
            ...
            if (state.state is LoginStateLogOut || state.state is LoginStateAccountDelete ) {
              Utils.closeDialog(context);
              Navigator.pushNamedAndRemoveUntil(
                  context, RouteNames.authenticationScreen, (route) => false);
            } else if (state.state is LoginStateLogOutLoading || state.state is LoginStateAccountDeleteLoading) {
