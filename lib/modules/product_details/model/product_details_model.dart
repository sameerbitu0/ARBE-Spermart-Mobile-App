...
class ProductDetailsModel extends Equatable {
  ...
  @override
  String toString() {
    return 'ProductDetailsModel(id: $id, totalProductReviewQty: $totalProductReviewQty, product: $product, relatedProducts: $relatedProducts, productReviews: $productReviews ,productVariants: $productVariants)';
  }
