...
abstract class AuthRepository {
  ...
  Future<Either<Failure, String>> accountDelete(String token);
}
...
class AuthRepositoryImp extends AuthRepository {
  ...
  @override
  Future<Either<Failure, String>> accountDelete(String token) async {
    try {
      final result = await remoteDataSource.accountDelete(token);
      localDataSource.clearUserProfile();
      return Right(result);
    } on ServerException catch (e) {
      return Left(ServerFailure(e.message, e.statusCode));
