              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'login_screen_input_username'.tr,
                  ),
                );
              },
            ),
            ...
            BlocBuilder<LoginBloc, LoginModelState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'login_screen_input_password'.tr,
            ...
            BlocBuilder<LoginBloc, LoginModelState>(
              ...
              builder: (context, state) {
                ...
                return PrimaryButton(
                  text: 'login_screen_sign_in_label_text'.tr,
                  onPressed: () {
      ...
      children: [
        Flexible(
          child: CheckboxListTile(
            ...
            title: Text(
              'login_screen_remember_me_text'.tr,
        ...
        InkWell(
          ...
          child: Text(
            'login_screen_forgot_password_text'.tr,
