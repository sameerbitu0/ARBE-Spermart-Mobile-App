...
class LoginStateAccountDeleteLoading extends LoginState {
  const LoginStateAccountDeleteLoading();
}
...
class LoginStateAccountDelete extends LoginState {
  final String msg;
  final int statusCode;

  const LoginStateAccountDelete(this.msg, this.statusCode);
