              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'contact_us_input_name'.tr,
          ...
          BlocBuilder<ContactUsFormBloc, ContactUsFormState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'contact_us_input_email'.tr,
                    fillColor: borderColor.withOpacity(.10),
                  ),
                );
              }),
          ...
          BlocBuilder<ContactUsFormBloc, ContactUsFormState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'contact_us_input_phone'.tr,
                    fillColor: borderColor.withOpacity(.10),
                  ),
                );
              }),
          ...
          BlocBuilder<ContactUsFormBloc, ContactUsFormState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'contact_us_input_subject'.tr,
                    fillColor: borderColor.withOpacity(.10),
                  ),
                );
              }),
          ...
          BlocBuilder<ContactUsFormBloc, ContactUsFormState>(
              ...
              builder: (context, state) {
                return TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'contact_us_input_message'.tr,
                    fillColor: borderColor.withOpacity(.10),
                  ),
                  minLines: 5,
                  maxLines: null,
          ...
          BlocBuilder<ContactUsFormBloc, ContactUsFormState>(
            ...
            builder: (context, state) {
              return state.status is ContactUsFormStatusLoading
                  ...
                  : PrimaryButton(
                      text: 'contact_us_button_sand_now'.tr,
                      onPressed: () {
